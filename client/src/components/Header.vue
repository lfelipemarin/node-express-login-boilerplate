<template>
  <v-toolbar app fixed clipped-left>
    <v-toolbar-side-icon class="hidden-md-and-up" @click.stop="toggleSideBar" v-if="$store.state.isUserLoggedIn"></v-toolbar-side-icon>
    ...
    <v-toolbar-items v-if="$store.state.isUserLoggedIn && $store.state.user.role == 'admin'">
